...
sherlock_info = ["Sherlock",
                 "90",
                 "A modernised series of adaptations of the Sherlock Holmes novels by Sir Arthur Conan Doyle. ",
                 "https://vignette.wikia.nocookie.net/bakerstreet/images/9/9d/BBC_Sherlock_Poster.jpg/revision/latest"
                 "?cb=20130416134410",
                 "https://www.youtube.com/watch?v=qlcWFoNqZHc"]

crouching_tiger_info = ["Crouching Tiger, Hidden Dragon",
                        "120",
                        "A young Chinese warrior steals a sword from a famed swordsman and then escapes into a world "
                        "of romantic adventure with a mysterious man in the frontier of the nation.",
...
big_bang_theory_info = ["The Big Bang Theory",
                        "21",
                        "A woman who moves into an apartment across the hall from two brilliant but socially awkward "
                        "physicists shows them how little they know about life outside of the laboratory.",
                        "https://vignette.wikia.nocookie.net/bigbangtheory/images/f/f3/Big_bang_theory_poster.jpg"
                        "/revision/latest?cb=20090218074507",
                        "https://www.youtube.com/watch?v=WBb3fojgW0Q"]

thor_info = ["Thor: Ragnarok",
             "130",
             "Two years after the battle of Sokovia, Thor is imprisoned by the fire demon Surtur in Muspelheim.",
             "https://upload.wikimedia.org/wikipedia/en/7/7d/Thor_Ragnarok_poster.jpg",
             "https://www.youtube.com/watch?v=v7MGUNV8MxU"]

panda_info = ["Kung Fu Panda",
              "92",
              "Po might just be the laziest, clumsiest panda in the Valley of Peace, but he secretly dreams of "
              "becoming a kung fu legend.",
              "https://www.fulcrumgallery.com/product-images/AZAA8ADA-P603955.jpg",
...
youth_info = ["Fang hua",
              ...
              "/MV5BMGIwM2NiZGEtYTNkZi00NjAzLThjMTAtODUzY2MyNjE4OTdlXkEyXkFqcGdeQXVyNTMyNTA3Mzc@._V1_UX182_CR0,0,182,"
              "268_AL_.jpg",
